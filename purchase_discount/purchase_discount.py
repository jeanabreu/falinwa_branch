    ...
    _columns = {
        'amount_untaxed': fields.function(_amount_all, method=True,
            ...
            store={
                ...
                'purchase.order.line': (_get_order, ['price_unit', 'taxes_id', 'discount', 'product_qty','order_id'], 10),
...
class purchase_order_line(orm.Model):
    ...
    _columns = {
        ...
        'price_subtotal': fields.function(_amount_line, string='Subtotal',
            store=
            {
                'purchase.order.line' : (lambda self, cr, uid, ids, c={}: ids, ['discount','price_unit','product_qty','taxes_id','order_id'], 20),
