...
#    Copyright (c) 2014-Today Falinwa Limited. All Rights Reserved.
#    Author: Chen Puyu <chen.puyu@elico-corp.com> / Hans Yonathan <hans.yonathan@falinwa.com>
#
...
* Step 5: Fapiao allocation to invoice: Fapiao and OpenERP invoices can be linked to each other
    """,
    'author': 'Elico Corp / Falinwa Limited',
    'website': 'http://www.openerp.net.cn / http://www.falinwa.com',
    'images': [],
    'depends': ['account','fal_group_by_commercial'],
    'data': [
        'fal_report.xml',
        'fapiao_sequence.xml',
