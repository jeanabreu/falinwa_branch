...
class mrp_production(models.Model):
    ...
    def _fal_moves_check_stock(self):
        ...
        for move_line in self.move_lines:
            if move_line.product_uom_qty > move_line.availability:
                is_ready = False
...
class stock_move(models.Model):
    ...
    def action_assign(self):
        ...
        floating_ready_self = self.filtered('raw_material_production_id.fal_floating_production_date').filtered(lambda r: r.raw_material_production_id.fal_fixed_production_date == False).filtered(lambda r: r.raw_material_production_id.state == 'confirmed').filtered('raw_material_production_id.fal_component_ready')
