        ...
        if context.get('active_id',False):
            ...
            for order_line in purchase_id.order_line:
                if order_line.product_id.third_party_id:
                    raise orm.except_orm(_('Warning!'), _('This is third party component. You cannot purchase the third party component, please cancel this request and make a manual incoming shipment for this component.'))
